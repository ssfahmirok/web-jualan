      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">Streaming</h1>
              <p className="text-slate-600">Langganan Netflix, Spotify, Disney+, dan lainnya</p>
            </div>
          </div>
        </motion.div>
            ...
            {filteredServices.map((service) => (
              <motion.div key={service.id} variants={itemVariants}>
                <Link href={`/streaming/${service.id}`}>
                  <Card className="group relative overflow-hidden bg-white border-slate-200 hover:border-rose-300 hover:shadow-xl hover:shadow-rose-500/10 transition-all duration-300 cursor-pointer h-full">
                    <CardContent className="p-0">
                      <div className="relative aspect-video">
                        <img
                          ...
                          onError={(e) => {
                            (e.target as HTMLImageElement).src = 'https://placehold.co/400x225/rose/white?text=Streaming';
                          }}
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-slate-900/20 to-transparent" />
                        <div className="absolute top-3 right-3">
                          <div className={`w-10 h-10 rounded-lg bg-gradient-to-br ${service.color} flex items-center justify-center shadow-lg`}>
                            <service.icon className="w-5 h-5 text-white" />
                          </div>
                        </div>
                      </div>
                      <div className="p-4">
                        <h3 className="text-slate-900 font-semibold mb-1 group-hover:text-rose-600 transition-colors">
                          {service.name}
                        </h3>
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-rose-500 to-pink-500 flex items-center justify-center group-hover:scale-110 transition-transform shadow-lg shadow-rose-500/30">
